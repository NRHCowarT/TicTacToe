...
//-(void)clearScoreButtonTapped:(UIButton *)button
            ...
            scoreLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, SCREEN_WIDTH-20, 40)];
            ...
            scoreLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(10, 50, SCREEN_WIDTH-20, 40)];
    ...
    UIButton * clearScoreButton = [[UIButton alloc] initWithFrame:CGRectMake(10, SCREEN_HEIGHT-50, SCREEN_WIDTH-20, 40)];
...
UIButton * clearBoardButton = [[UIButton alloc] initWithFrame:CGRectMake(10, SCREEN_HEIGHT-95, SCREEN_WIDTH-20, 40)];
//            clearScoreButton.titleLabel.text = @"Clear Score";
//            clearScoreButton.titleLabel.textColor = [UIColor blackColor];
